...
- **Alltagsbefehle ohne Wartezeit:** Lautstärke („Lautstärke auf 30"), Stumm, Medien („Pausiere die Musik", „Nächstes Lied", „Stop"), Helligkeit, Bildschirm sperren sowie Uhrzeit und Datum führt KIKI direkt aus — ohne Modelllauf, in etwa einer halben Sekunde. Alles Weitere bleibt im normalen Assistenten-Pfad.
...
- **Kompakte Sprachantwort:** Auf Mikrofonfragen liest KIKI höchstens drei Sätze bzw. 450 Zeichen vor — satzweise gestreamt, während die Antwort noch entsteht. Gekürzte sowie aus Datenschutzgründen ausgelassene Details erscheinen vollständig im automatisch geöffneten Chat.
